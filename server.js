...
var k8stoken = process.env.K8STOKEN || 'k8s token to connect';
...
var containerImage = process.env.CONTAINER_IMAGE || 'chrisley75/kubernetes-hacked-app:' + applicationVersion
...
logger.debug('K8SURL=' + process.env.K8SURL);
logger.debug('K8STOKEN=' + process.env.K8STOKEN);
...
app.get(handlerPathPrefix + '/', function (req, res) {
    res.render('home', {
      message: message,
      Kubernetes_Dashboard_URL: k8surl,

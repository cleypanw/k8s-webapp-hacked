...
LABEL org.opencontainers.image.title="kubernetes-hacked-app!" \
      ...
      org.opencontainers.image.authors="Christopher LEY" \
      org.opencontainers.image.url="" \
      org.opencontainers.image.documentation="" \
      org.opencontainers.image.vendor="Christopher LEY" \
